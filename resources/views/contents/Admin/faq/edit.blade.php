            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Form Ubah FAQ</h4>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tanya" id="tanya"
                                                ...
                                                value="{{ $faq->tanya }}" autocomplete="off">
                                            @error('tanya')
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="jawab" id="jawab"
                                                class="form-control summernote @error('jawab') is-invalid @enderror">{{ $faq->jawab }}</textarea>
                                            @error('jawab')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
