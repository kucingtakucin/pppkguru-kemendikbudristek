            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Form Ubah Kategori Pengaduan</h4>

                                <form action="{{ route('admin.ref-kategori-pengaduan.update', $kategori->id) }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nama" id="nama"
                                                ...
                                                value="{{ $kategori->nama }}" autocomplete="off">
                                            @error('nama')
