                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('admin.infografis') }}">Informasi</a></li>
            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.infografis.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf @method('PATCH')
                            <div class="form-group row mb-4">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Judul Infografis</label>
                                <div class="col-sm-9">
                                    <input type="text" name="judul" class="form-control" id="horizontal-firstname-input" value="{{ $data->judul }}">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="category" id="inlineRadio1" value="gambar" {{ $data->category == 'gambar' ? 'checked':'' }}>
                                        <label class="form-check-label" for="inlineRadio1">Gambar</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="category" id="inlineRadio2" value="file" {{ $data->category == 'file' ? 'checked':'' }}>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" name="deskripsi" class="form-control summernote" id="horizontal-email-input">{!! $data->deskripsi !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Upload File/Foto</label>
                                <div class="col-sm-9">
                                    <a href="{{ asset('upload/infografis/'.$data->name_file) }}" class="btn btn-warning btn-sm mb-2" target="_blank">Lihat File</a>
                                    <input type="hidden" name="name_file_old" value="{{ $data->name_file }}">
