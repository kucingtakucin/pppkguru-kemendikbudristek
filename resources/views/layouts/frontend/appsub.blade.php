                ...
                <div class="col-auto col-lg-8 menu-order px-lg-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                        <ul class="navbar-nav alt-font">
                            <li class="nav-item">
                                <a href="{{ route('home') }}" class="nav-link section-link">Beranda</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('home') }}#syarat" class="nav-link section-link">Alur Seleksi</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('home') }}#unduhan" class="nav-link section-link">Unduh Dokumen</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('home') }}#faq" class="nav-link section-link">FAQ</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('home') }}#kontak" class="nav-link section-link">Kontak</a>
                            </li>
