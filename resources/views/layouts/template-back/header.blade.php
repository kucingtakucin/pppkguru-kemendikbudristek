                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('frontend/images/custom/pppk-light.png') }}" alt="" height="60" width="200">
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item text-danger" href="{{ route('get.logout') }}"><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i> <span key="t-logout">Logout</span></a>
                            </div>
                        </div>
